...
# MongoDB connection - Corrected URI
...
CHANNEL_ID = "-1002605592823"  # Replace with your channel ID
...
async def send_to_telegram(movie):
    ...
    try:
        ...
        if poster_url:
            ...
            # Send text message if no poster
            payload = {
                "chat_id": CHANNEL_ID,
                "text": caption,
                "parse_mode": "HTML"
...
async def create_movie():
    try:
        ...
        # Transform input data with dynamic platform handling
        movie_data = {
            "title": data.get("Title"),
            "type": data.get("Type"),
            "released": data.get("Released"),
